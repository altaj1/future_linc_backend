...
export class UserController extends BaseController {
    ...
    public create = async (req: Request, res: Response) => {
        ...
        return this.sendCreatedResponse(res, result, 'User created successfully');
    };
    ...
    public getOne = async (req: Request, res: Response) => {
        ...
        return this.sendResponse(res, 'User retrieved successfully', HTTPStatusCode.OK, result);
    };
    ...
    public update = async (req: Request, res: Response) => {
        ...
        return this.sendResponse(res, 'User updated successfully', HTTPStatusCode.OK, result);
    };
